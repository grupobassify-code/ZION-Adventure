...
// Refined physics for ultra-smooth movement
export const GRAVITY = 0.30;
export const MAX_FALL_SPEED = 7.2;
export const PLAYER_ACCEL = 0.32;
export const PLAYER_DECEL = 0.22;
export const PLAYER_MAX_SPEED = 2.65;
export const JUMP_FORCE = -6.1;
...
export const DASH_COOLDOWN = 36; // frames (~0.6s)
...
export const DAGGER_RECHARGE_TIME = 135; // frames (~2.25s)
export const DAGGER_SPEED = 5.2;
export const DAGGER_LIFETIME = 75;
export const DAGGER_BASE_DAMAGE = 1;

// Defense / Shield & Showdown
export const PERFECT_PARRY_WINDOW = 9; // frames of initial block that triggers showdown parry
export const SHOWDOWN_SLOWMO_DURATION = 45; // Slow motion bullet-time counter window
export const SHOWDOWN_COUNTER_DAMAGE = 9; // Devastating 3.5x critical counter attack
...
export const SPECIAL_PASSIVE_REGEN = 0.06; // Passive SP charge over time (~3.6 SP/sec)
export const SPECIAL_HIT_SP_GAIN = 3.0; // SP gained per sword hit
