      ...
      <header className="relative z-10 w-full max-w-5xl flex items-center justify-between gap-2 pt-1 sm:pt-2">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            ...
            <span className="hidden md:inline">CONTROLES</span>
          </button>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-300 mt-1.5 max-w-2xl leading-relaxed">
                          Reconstruye el colosal mecanismo del tiempo con las 6 piezas ancestrales obtenidas al derrotar al jefe del acto final de cada zona (¡incluyendo Jungle Run!). ¡Al completarlo se activará la cinemática de giro y desbloquearás el Casillero de skins estilo Fortnite!
                        </p>

                        {/* 6 Pieces Mini Status Icons */}
                        <div className="flex items-center gap-2 mt-3 flex-wrap">
                          <span className="text-[11px] font-mono text-slate-400 font-bold mr-1">
                            Piezas [{placedCount}/6]:
                          </span>
